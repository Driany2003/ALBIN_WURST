...
public class EmpresaDTO {
  ...
  public EmpresaDTO(String empImagenLogo,Integer empId, String empNombreComercial, Date empFechaContratoInicio, Date empFechaContratoFin, String empTelefono, Boolean empIsActive) {
