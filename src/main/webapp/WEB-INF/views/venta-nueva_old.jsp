                            ...
                            <form id="ventaForm">
                                <div class="form-body">
                                    <div id="productos-container">
                                        <div id="categoriaContainer" class="d-flex flex-wrap">

                                        </div>
                                        <div id="subCategoriaContainer" class="d-flex flex-wrap" style="display: none">

                                        </div>
                                        <div id="detalleProductoContainer" class="d-flex flex-wrap" style="display: none">
