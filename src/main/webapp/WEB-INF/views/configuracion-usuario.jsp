            ...
            <div class="modal-body">
                <form id="editarUsuarioForm" enctype="multipart/form-data">
                    ...
                    <ul class="nav nav-tabs" id="editarUsuarioTabs" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link ${sessionScope.usuSessionNivel != 'ADMINISTRADOR' ? 'active' : ''}" id="personal-edit-tab" data-toggle="tab" href="#personal-edit" role="tab" aria-controls="personal-edit"
                               aria-selected="false">
                                <i class="fas fa-id-card" style="margin-right: 5px;"></i>
                                Información Personal
                            </a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-4">
                                            <div class="form-group bmd-form-group">
                                                ...
                                                <input type="text" class="form-control" name="usuario_apellido_paterno_edit" id="usuario_apellido_paterno_edit" maxlength="35" placeholder="Ingresar apellido paterno" required>
                                            </div>
                                        </div>
                                        <div class="col-12 col-md-4">
                                            <div class="form-group bmd-form-group">
                                                ...
                                                <input type="text" class="form-control" name="usuario_apellido_materno_edit" id="usuario_apellido_materno_edit" maxlength="35" placeholder="Ingresar apellido materno" required>
                                            </div>
                                        </div>
                                        <div class="col-12 col-md-4">
                                            <div class="form-group bmd-form-group">
